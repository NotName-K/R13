...
l = ['alertAlertas', 'alertPrecip', 'alertTmpMax', 'alertTmpMin', 'alertVelViento'] 
m = ['tmpMin', 'temp.night', 'temp.morn', 'feels_like.night', 'feels_like.morn']
...
for i in k: 
  k[k.index(i)][0] = data['dt'].get(k[k.index(i)][0])
  k[k.index(i)][0] = datetime.fromtimestamp(k[k.index(i)][0]).strftime('%Y-%m-%d')
